	...
	switch(arguments.length){
		...
		case 1:
			...
			if((typeof a)=="string")
			{
				if(a.indexOf("/")>-1){
					var split="/";
					this.num =parseInt(a.split(split)[0]);
					this.den =parseInt(a.split(split)[1]);
				}
			...
			{		
				...
				if(a.indexOf(".")>-1){
					...
					this.num = whole * math.pow(10,deg)+parseInt(decimal);
...
Rational.prototype.add = function(other){
	var n = other.num*this.den+this.num*other.den;
	var d = other.den*this.den;
