define("Model",function(require){
	...
	//		return Backbone.sync.apply(this, arguments);
		...
		ajax:function(){
			return sync.ajax.apply(this,arguments);
		},
		...
		parse: function(resp, options) {
			...
			_.each(resp,function(c,k){
				...
				if(this.structure[k].type == "DateTimeField"){
					if(c == NaN || c == "NaN"||c == undefined)
						c = "January 1, 2015 01:01:00";	
					d = new Date(c);
					if(d == "Invalid Date"){
						c = "January 1, 2015 01:01:00";	
						d = new Date(c);
					...
					resp[k] = d.getFullYear()+m+day+hours+minutes+seconds;
				}
			},this);
	...
	var module = Obj.new(Model,inherit)
	...
	Obj.addUnderscoreMethods(module, modelMethods, 'attributes');
